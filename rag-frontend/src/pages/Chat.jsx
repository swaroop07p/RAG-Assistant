...
export const Chat = () => {
  ...
  return (
    <div className="flex md:h-[calc(100vh-8rem)] h-[calc(100dvh-8rem)] bg-white dark:bg-darkCard rounded-2xl border border-slate-200 dark:border-darkBorder overflow-hidden shadow-sm">
        ...
        {isHistoryOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute md:relative z-20 md:h-full h-[80vh] border-r rounded-xl border-slate-200 dark:border-darkBorder bg-slate-100 dark:bg-slate-900 flex flex-col shrink-0 overflow-hidden shadow-xl md:shadow-none"
            >
